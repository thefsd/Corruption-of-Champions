...
package classes
{
	...
	public class PerkLib
	{
		...
		public static const AssHenna:PerkType = mk("Ass Henna", "Ass Henna", "Your attractive fake tattoo [if (assholeOffLimits = true) also reduces the amount of anal attention you get|<b>looks good, but hasn't done much else since your genitals changed</b>].")
