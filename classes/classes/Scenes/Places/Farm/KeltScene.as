...
private function keltMainEncounterPostBlowjob():void {
	...
	if(player.hasStatusAffect("BlowjobOn") >= 0) {
		...
		if (player.lust >= 75 || player.statusAffectv2("Kelt") >= 90 && rand(2) == 0) {
			...
			outputText("You lose track of time, moaning and whimpering beneath your master as he ruthlessly takes his pleasure from your distended " + assholeOffLimits("cunt", "ass") + ".  Do you cum again?  Almost certainly... but it is hard to focus on that one sensation.  The much greater sensation welling up within you is a sense of rightness.  This is where you belong; this is where you are happy.  As his cock begins to swell within you, preparing to unload his spunk deep inside, your voice rises in a cry of jubilation.  Impaled upon your master's cock, now and forever, being filled with his seed... you could want nothing more.\r\r", false);
			...
			player.slimeFeed();
			//(+10 Submissiveness)
			if(assholeOffLimits() ? cuntChange(70,true) : buttChange(70,true)) outputText("\r\r", false);
			player.addStatusValue("Kelt",2,10);
