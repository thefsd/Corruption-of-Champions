...
private function boneTheShitOutofKihaHolesWithHorsecock():void {
	...
	if(flags[kFLAGS.KIHA_HORSECOCK_FUCKED] == 0) {
		...
		if(player.statusAffectv1("Exgartuan") == 1) outputText("  Exgartuan suggests, \"<i>She probably loved it if she had as much fun as I did.</i>\"");
...
private function savinTheAnalForKiha():void {
	...
	outputText(".  Moving your hips in tandem with hers, the two of you must look to any observers like a couple engaged in some perverse dance, grinding and teasing and groping at each other until you're both flush and Kiha's thighs are slick with her girl-lube");
	...
	outputText("[pg]Kiha screams and cums, clamping down hard on your fist and cock as gushers of hot girlcum flood out of her loins.  \"<i>Y-yeaaaahh!</i>\"  she cries, \"<i>Come on, you think... you think I'll just let you cum... Just like that!?  Just for getting me... getting me off till I can't - aaaahhhh! - think straight... and I'd let you cum too; shoot a big hot load right up that ass you're so obsessed with?</i>\"");
...
private function fuckKihasVagInCamp():void {
	...
	outputText("[pg]With a smooth, confident motion, Kiha easily peels you out of your [armor] to expose you as completely as herself.  You let her toss your gear aside before you take charge again, groping one of her squeezable, soft breasts in hand as you lower her to the ground.  She allows herself to be handled, her actions surprisingly meek for one so often focused on physical dominance, and you take advantage of it while you can.  The dragoness lies on the ground, her legs lewdly splayed to reveal the glimmering delta of her ever-wet womanhood, flush with the arousal you've kindled within her.");
...
private function giveKihaIncubusDraft():void {
	...
	outputText("  Your lover screams, hurtling toward orgasm -- until your stop, perfectly still as your [butt] rests against her thighs.  You relax your " + assholeOffLimits("vaginal", "anal") + " muscles, careful not to give the cock snugly stuffed inside you any extra stimulation.  Made too submissive by sensation, Kiha cannot even attempt to defy your wishes, only lying in a pool of her cum and fem-lube, pleading for mercy.");
	...
	outputText("[pg]Roaring, Kiha thrusts her cock up into your " + assholeOffLimits("cunt", "ass") + " as you slam down upon her, meeting half-way as the first great, hot load of dragon-spunk shoots into your ass.  You grind your [" + assholeOffLimits("vagina", "asshole") + "] around your lover's reptilian prick, milking out squirt after squirt of dragon-spooge until white streamers leak freely out of your " + assholeOffLimits("pussy", "asshole") + " and coat the ground beneath you.");
...
private function fuckKihaWithATentacle():void {
	...
	outputText(".  As you alternatively pound away at her front and back door, you can feel her dark scaly body contorting between your arms: Kiha is drowning in an unholy fountain of pleasure.  She thrashes wildly and nearly escapes your grasp; the ferocious girl isn't one to be dominated, and in her oblivious passion she lets her inhumane vitality express to its full extent.  Although you were rather rough and unsubtle with her cunt, it is literally dripping cascades of fem-spunk; the shimmering liquid flows down her toned thighs and releases hot steam as it impregnates the cursed floor.  Some of her boiling sexual essence is coated on your [cock " + y + "] as you thrust in and out of her gaping pussy.  The hot fluid as an aphrodisiac on your plant-like junk and makes it even harder; your mind is filled with feverish sensations as the both of you descend even deeper in libertinism.");
	//{if another tentacle dick}
	if(z != -1) {
...
private function inviteKihaForDickings():void {
	...
	outputText("[pg]Kiha sniffles softly and continues, \"<i>I almost feel bad for Lethice to have you as an enemy.  Do me a favor and kick her in the twat for me when you find her, okay?</i>\"  You both share a nervous laugh at that and slowly end the hug.  Dabbing at one of her tears, you suggest, \"<i>Come on, lets carry your stuff over and get you moved in.</i>\"  Kiha's tail wags happily, and the two of you begin gathering her things.");
...
private function ghostboobiesKiha():void {
	...
	outputText("[pg]That's what you were waiting for.  Slooowly drawing out of her cunt and not even bothering to flick the excess girl-cum off your fingers, you grab up the Gro+ and smoothly inject the rest of the serum into her other, neglected breast.  Her ecstasy as the orb began to balloon outward nearly knocks you over, issuing forth in huge and overpowering waves of lust.  Before you know it you're on your back, both you and Kiha (in a constant cycle of overpowering limbs and losing control of them) grabbing and squeezing and rubbing anything that feels good on Kiha's body as your dragon girl's satisfaction ratchets her sensitivity up to even higher levels.");
...
internal function kihaBitchesOutCorruptPCs():void {
	...
	if(!followerKiha()) {
		...
		outputText("[pg]Kiha closes her eyes and launches herself in to the air, only leaving a few tears for the parched wasteland to claim.");
		doNext(1);
	}
...
internal function pcWinsDomFight():void {
	...
	if(select == 0) outputText("works her way on top of your pelvis and impales herself on your " + cockDescript(x) + ", grinning like a mad fool as she does so.  \"<i>Told you!</i>\"  She remarks. \"<i>And was that really the best you could do?  With the hair pulling?  *Sigh* I guess I have to teach you a thing or two...</i>\"  Lowering herself down in between savage slams of her rump against your pelvis, the cool and arrogant woman takes the " + player.skin() + " of your neck and pierces it with her canines, causing you to cry out as the sting of her bite flows through you.  Humming her approval, she carries on with the coarse treatment of your entrapped cock, mashing and working forth a crescendo of skin on skin slapping noises."); 
